...
export const NAVEGACAO: readonly GrupoNav[] = [
  ...
  { titulo: "Processos", itens: [{ titulo: "Correção retroativa", href: "/correcao" }, { titulo: "Conciliação bancária", href: "/conciliacao" }] },
  { titulo: "Relatórios", itens: [{ titulo: "Pagamentos", href: "/relatorios/pagamentos" }, { titulo: "Consolidado", href: "/relatorios/consolidado" }, { titulo: "Auditoria", href: "/relatorios/auditoria" }] },
];
