...
/** Mensaje de la pantalla cuando la consulta supera `LIMITE_LINHAS_RELATORIO`. */
export const MSG_LIMITE_LINHAS_RELATORIO = "Período com mais de 20.000 registros. Refine o filtro.";
