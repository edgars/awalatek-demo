...
import { MAX_HISTORICO, montarFicha, MSG_NENHUM_PAGAMENTO, selecionarHistorico, type PagamentoConsulta } from "./consulta";
...
describe("D7 — máscara da consulta", () => {
  ...
  it("corrigido: sempre ***.***.XXX-XX (dígitos 7–9 e 10–11 do CPF de 11 com zeros)", () => {
    ...
    expect(mascaraCpfConsulta("01234567890", TODOS)).toBe("***.***.678-90");
  });
